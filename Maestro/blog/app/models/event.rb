class Event < ApplicationRecord
  ...
  validates :time, allow_nil: true, format: { with: /\A[0-2][0-9]:[0-5][0-9]\z/, message: "Enter proper format please. " }  #[-\+][0-9]{4} or [0-9]{4}-[0-9]{2}-[0-9]{2}[0-2][0-9]:[0-5][0-9]:[0-5][0-9] UTC
